## Convert all functions made in accounts.py as mcp tools so our custom mcp server will be equiped with its own tools
from mcp.server.fastmcp import FastMCP
from accounts import Account ##import full class
...
@mcp.resource("accounts://accounts_server/{name}") ## resource 1
